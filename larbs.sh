...
[ -z "$dotfilesrepo" ] && dotfilesrepo="https://github.com/nguwijy/voidrice.git"
[ -z "$progsfile" ] && progsfile="https://raw.githubusercontent.com/nguwijy/LARBS/master/progs.csv"
...
adduserandpass() { \
	...
	usermod -a -G wheel,audio,video,storage "$name" && mkdir -p /home/"$name" && chown "$name":wheel /home/"$name"
